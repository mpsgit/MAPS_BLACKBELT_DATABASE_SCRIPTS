...
BEGIN
  ...
  -- insert into offr_prfl_sls_cls_plcmt and offr_sls_cls_sku if necessary
  l_log := 'insert offr_prfl_sls_cls_plcmt and offr_sls_cls_sku';
  FOR rec IN (
  ...
  BEGIN
    ...
    FOR rec IN (
                  ...
                  ,CASE
                   ...
                   --/latest version calculations
                  /*,CASE
                     WHEN (osl_current.max_sales_type = 1 OR
                          osl_current.max_sales_type IS NULL)
                          AND l_sls_typ = 1 THEN
                      0
                     WHEN osl_current.max_sales_type = 2
                          AND l_sls_typ = 2 THEN
                      1
                     ELSE
                      2
                   END status*/
