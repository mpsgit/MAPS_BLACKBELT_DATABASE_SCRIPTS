...
SELECT o.offr_id  AS intrnl_offr_id
      ...
      ,(nvl((SELECT MAX(1)
            ...
            0)) AS has_unit_qty
      ,o.offr_typ
      ,pa_foresight.get_osl_units(osl_current.offr_sku_line_id) AS forcasted_units
 ...
 AND mvps.veh_id = o.veh_id
  ...
  BEGIN
    ...
    SELECT obj_edit_offr_line(
                ...
                pg_wght, sprd_nr, offr_prfl_prcpt_id, has_unit_qty, offr_typ, forcasted_units, forcasted_date)
      BULK COLLECT
    ...
    LOOP
      ...
      p_edit_offr_table(p_edit_offr_table.LAST)
        := obj_edit_offr_line(p_status, osl_rec.mrkt_id, osl_rec.offr_perd_id, osl_rec.offr_lock, osl_rec.offr_lock_user,
                              ...
                              osl_rec.forcasted_units, osl_rec.forcasted_date);
    END LOOP;
