...
, SCT_SLS_TYP_ID NUMBER 
, SCT_AUTCLC_EST_IND CHAR(1 BYTE) 
, SCT_AUTCLC_BST_IND CHAR(1 BYTE)
...
COMMENT ON COLUMN MRKT_SLS_PERD.SCT_SLS_TYP_ID IS 'Sales type for which trend allocation was last calculated.';
