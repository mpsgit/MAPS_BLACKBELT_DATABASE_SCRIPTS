--------------------------------------------------------
--  DDL for Trigger TR_BUI_CUSTMSEG_MSTR
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER TR_BUI_CUSTMSEG_MSTR 
--
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON custm_seg_mstr
  FOR EACH ROW
--
DECLARE
...
/
ALTER TRIGGER TR_BUI_CUSTMSEG_MSTR ENABLE;
