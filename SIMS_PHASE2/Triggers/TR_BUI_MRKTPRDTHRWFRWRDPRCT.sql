--------------------------------------------------------
--  DDL for Trigger TR_BUI_MRKTPRDTHRWFRWRDPRCT
--------------------------------------------------------

CREATE OR REPLACE TRIGGER TR_BUI_MRKTPRDTHRWFRWRDPRCT 
  --
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON mrkt_perd_throw_forwrd_prct
  FOR EACH ROW
--
DECLARE
...
/
ALTER TRIGGER TR_BUI_MRKTPRDTHRWFRWRDPRCT ENABLE;
