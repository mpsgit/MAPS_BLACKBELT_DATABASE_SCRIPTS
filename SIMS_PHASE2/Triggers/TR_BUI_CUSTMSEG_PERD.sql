--------------------------------------------------------
--  DDL for Trigger TR_BUI_CUSTMSEG_PERD
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER TR_BUI_CUSTMSEG_PERD 
--
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON custm_seg_perd
  FOR EACH ROW
--
DECLARE
  ...
  IF pa_updt_ts.update_timestamps() = 1 THEN
    ...
    ELSIF (inserting) THEN
      ...
      IF :new.creat_user_id = USER THEN
        ...
        -- Use a more useful value than USER.
      END IF;
...
/
ALTER TRIGGER TR_BUI_CUSTMSEG_PERD ENABLE;
