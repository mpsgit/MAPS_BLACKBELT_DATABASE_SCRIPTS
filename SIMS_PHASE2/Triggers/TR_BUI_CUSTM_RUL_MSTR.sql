--------------------------------------------------------
--  DDL for Trigger TR_BUI_CUSTM_RUL_MSTR
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER TR_BUI_CUSTM_RUL_MSTR 
--
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON custm_rul_mstr
  FOR EACH ROW
--
DECLARE
...
BEGIN
  IF pa_updt_ts.update_timestamps() = 1 THEN
    ...
    ELSIF (inserting) THEN
      SELECT seq_rul_id.nextval INTO :new.rul_id FROM dual;
...
/
ALTER TRIGGER TR_BUI_CUSTM_RUL_MSTR ENABLE;
