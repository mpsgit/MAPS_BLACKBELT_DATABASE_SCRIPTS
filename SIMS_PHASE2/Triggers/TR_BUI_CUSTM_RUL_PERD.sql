--------------------------------------------------------
--  DDL for Trigger TR_BUI_CUSTM_RUL_PERD
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER TR_BUI_CUSTM_RUL_PERD 
--
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON custm_rul_perd
  FOR EACH ROW
--
DECLARE
...
/
ALTER TRIGGER TR_BUI_CUSTM_RUL_PERD ENABLE;
