--------------------------------------------------------
--  DDL for Trigger TR_BUI_MRKTTRNDSLSPERD_SLS_TYP
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER TR_BUI_MRKTTRNDSLSPERD_SLS_TYP 
--
  -- Trigger generated by pa_updt_ts.  Do not change this trigger manually.
  --
  BEFORE INSERT OR UPDATE ON mrkt_trnd_sls_perd_sls_typ
  FOR EACH ROW
--
DECLARE
...
/
ALTER TRIGGER TR_BUI_MRKTTRNDSLSPERD_SLS_TYP ENABLE;
