...
/
CREATE OR REPLACE TYPE OBJ_PA_TREND_ALLOC_CRRNT_TABLE AS TABLE OF OBJ_PA_TREND_ALLOC_CRRNT_LINE;
/
...
/
CREATE OR REPLACE TYPE OBJ_PA_TREND_ALLOC_RULES_TABLE AS TABLE OF OBJ_PA_TREND_ALLOC_RULES_LINE;
/
...
/
CREATE OR REPLACE TYPE OBJ_PA_TREND_ALLOC_SGMNT_TABLE AS TABLE OF OBJ_PA_TREND_ALLOC_SGMNT_LINE;
/
...
/
CREATE OR REPLACE TYPE OBJ_PA_TREND_ALLOC_VIEW_TABLE AS TABLE OF OBJ_PA_TREND_ALLOC_VIEW_LINE;
/
...
/
CREATE OR REPLACE TYPE OBJ_PA_TREND_ALLOC_PRD_DTL_TBL AS TABLE OF OBJ_PA_TREND_ALLOC_PRD_DTL_LN;
/
